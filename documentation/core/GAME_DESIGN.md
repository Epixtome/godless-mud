...
## 9. SHRINES & SOVEREIGNTY (V7.2)
Shrines are the tactical anchors of the world. They project **Influence Tides** and serve as **Class Hubs**.

### 9.1 Agnostic Capture
* **Ownership**: Shrines are initially agnostic (or assigned a home kingdom). They can be **Captured** by enemy kingdoms through combat or rituals.
* **Flipping**: When a shrine's **Potency** is drained to 0, it becomes Neutral. The first kingdom to perform a `Claim` ritual at the Neutral shrine becomes the new owner.

### 9.2 The Blessing Ritual (Class Swapping)
* **Deity Hubs**: Every shrine is dedicated to a **Deity** (e.g., Fenris, Valeros).
* **Kit Exchange**: Players can swap their active Class Kit at a shrine by performing a **Blessing Ritual**.
* **Favor Scaling**: 
    - **Kingdom Bonus**: If the player's kingdom matches the shrine's `captured_by` kingdom, the Favor cost for the ritual is significantly reduced.
    - **Agnostic Cost**: Swapping at a neutral or enemy-held shrine incurs a much higher Favor penalty.
