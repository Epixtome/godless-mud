...
### Sovereignty & Shrines
*   **@shrine place <deity> <kingdom> [potency]**: Places a divine shrine with lore-aware descriptions.
*   **@shrine set <id> <property> <value>**: Live-edits shrine properties (Potency, HP, Kingdom).
*   **@shrine list**: Views the active global shrine registry and capture states.
*   **@shrine delete <id>**: Safely removes a shrine from the world and database.
*   **influence**: Displays the global Sovereignty Map (Tides of Power).
