...
3.  **[COMPLETED] Migrate One:** Change `Monster` to use the Event.
4.  **[COMPLETED] Migrate All:** Change `Player` to use the Event.
5.  **[CURRENT STEP] Verify:** Kill a Player or Monster. The `[AUDIT]` log should now be completely silent.
